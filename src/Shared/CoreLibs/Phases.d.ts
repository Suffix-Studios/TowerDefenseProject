...
import Pipeline from "@rbxts/planck/out/Pipeline";
import Scheduler from "@rbxts/planck/out/Scheduler";
import type { Plugin as PluginInterface } from "@rbxts/planck/out/types";

export class Plugin<T extends unknown[]> implements PluginInterface {
